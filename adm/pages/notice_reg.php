...
<div class="pop-window fade" id="modal-alert">
	<div class="alert">
		...
		<div class="modal_foot">
			<a href="javascript:noticeReg();" class="b_red">확인</a>
...
<div class="con_wrap">
		...
		<div class="panel mody">
			<ul>
				...
				<li class="select_input">
					<div>
						<select name="n_state" id="n_state" class="">
				...
				<li><h5>제목</h5></li>
				<li>
					<input type="text" placeholder="제목" class="mody_tit" name="n_title" id="n_title" maxlength="255">
				</li>
				<li><h5>내용</h5></li>
	...
	<!-- button area -->
	<div class="btn_wrap">
		<a href="javascript:noticeRegSel();" class="b_blue">등록</a>
...
function noticeReg(){
	...
	var ajax_url = "/proc/notice_reg_ok.php";	
