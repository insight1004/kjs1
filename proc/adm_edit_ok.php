...
//파라미터 NULL 체크
if($a_id=='' || $a_name=='' || $a_level=='' || $a_tel1=='' || $a_tel2=='' || $a_tel3==''){
...
if(mysqli_num_rows($result) < 1) {
	...
	if($admState == 0){
		...
		$sql = " UPDATE ".$db['admin_table']." SET a_name='".$a_name."', a_level='".$a_level."', a_tel='".$a_tel."', a_ip='".$a_ip."', a_edit_date='".date("Y-m-d H:i:s")."', a_reg_id='".$a_reg_id."' WHERE a_id='".$a_id."' ";
