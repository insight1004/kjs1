...
! function(t) {
        ...
        n = r(15), i = function() {
            ...
            return t.prototype.vars = function() {
                ...
                return 0 > t || t > 1 || 0 > i || i > 1 ? this.error("Bezier x values should be > 0 and < 1") : (u = 4, l = .001, c = 1e-7, h = 10, P = 11, T = 1 / (P - 1), v = o.call(e, "Float32Array") >= 0, n = function(t, e) {
                    ...
                    var r, s, n, o, a, p, u;
                    for (p = 0, r = 1, u = P - 1; r !== u && M[r] <= e;) p += T, ++r;
    ...
    t.exports = function(t, e, r, g, v, w, S) {
        ...
        if (E) {
            ...
            l(D, P, !0), !i && a(k, d) && o(D, c, m), M && E.name !== y && (C = !0, O = function() {
                return E.call(this)
            })
        }
        if (i && !S || !f && !C && k[c] || o(k, c, O), p[e] = O, p[P] = m, v)
            if (b = {
                    values: M ? O : T(y),
                    keys: w ? O : T(_),
                    entries: M ? T("entries") : O
                }, S)
                for (x in b) x in k || n(k, x, b[x]);
